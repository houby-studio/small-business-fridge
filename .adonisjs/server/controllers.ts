...
export const controllers = {
  api: {
    ...
    Mcp: () => import('#controllers/api/mcp_controller'),
    McpOauthMeta: () => import('#controllers/api/mcp_oauth_meta_controller'),
  ...
  web: {
    admin: {
      ...
      Invitations: () => import('#controllers/web/admin/invitations_controller'),
    ...
    Ratings: () => import('#controllers/web/ratings_controller'),
